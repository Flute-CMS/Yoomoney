...
class CompletePurchaseResponse extends AbstractResponse implements RedirectResponseInterface
{
    ...
    {
        // Получаем это, потому что обычное поле amount на кой-то возвращает сумму с комиссией, а нам нужна сумма без комиссии
        return $this->getWithdrawAmount() ?? floatval($this->data['amount']);
    }
